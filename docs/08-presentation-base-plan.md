...
### 내비게이션 (Navigation)
#### [NEW] [Screen.kt](../app/src/main/java/com/ezlevup/simplefocustimer/presentation/navigation/Screen.kt)
- Sealed 클래스 `Screen(val route: String)`.
- 객체: `Timer`, `History`.

#### [NEW] [SimpleFocusNavHost.kt](../app/src/main/java/com/ezlevup/simplefocustimer/presentation/navigation/SimpleFocusNavHost.kt)
...
#### [MODIFY] [MainActivity.kt](../app/src/main/java/com/ezlevup/simplefocustimer/MainActivity.kt)
